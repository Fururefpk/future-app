...
window.FPH.rent = (() => {
  ...
  async function initializePaystackPayment(invoiceId, payload) {
    Cache.del('rent:mine:{}');
    return api.post(`/rent/invoices/${invoiceId}/paystack/initialize`, payload);
  }
  ...
  return { myInvoices, getAll, getById, getPayments, generate, update, voidInvoice, recordPayment, initializePaystackPayment, revenueSummary, reminders, pdfUrl, PAYMENT_METHODS, STATUS_COLORS };
})();
...
describe('Paystack route validation', () => {
  it('POST /api/v1/rent/invoices/invalid/paystack/initialize returns 400 without amount', async () => {
    const res = await request(app)
      .post('/api/v1/rent/invoices/invalid/paystack/initialize')

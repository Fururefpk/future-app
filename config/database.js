...
// Some Windows/ISP DNS resolvers refuse MongoDB SRV lookups. Use public
// resolvers for the Atlas `mongodb+srv` record; override if needed in hosting.
...
const connectDB = async () => {
  ...
  try {
    ...
    // Do not start the API with no database. Reconnects after a successful
    // connection are handled by the `disconnected` event above.
    throw error;
  }
};
